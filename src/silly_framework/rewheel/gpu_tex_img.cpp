...
using namespace silly_framework::rewheel;
namespace impl = silly_framework::rewheel;

gl::Texture2D impl::load_texture2d_from_stb(const stb_decoded_image_view& img) {
